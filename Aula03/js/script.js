//criar as variáveis para fazer referencia aos controles html
...
txtconvenio.onclick = function () {
  texto.innerHTML =
    "Salários até R$ 2.500,00 o desconto é de 5%; caso contrário o desconto será de 7,5%";
};

txtfilhos.onclick = function () {
  texto.innerHTML =
    "Se o funcionário não tem filhos, então não receberá; caso contrario, receberá 5% do salário por filho";
};
